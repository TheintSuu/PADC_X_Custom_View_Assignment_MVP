package com.example.padc_x_custom_view_assignment.fragments
...
class  TaskFragment : Fragment(), TaskItemDelegate {
    ...
    private fun setupRecycler() {
        ...
        rvTaskFragment.layoutManager = linearLayoutManager
        rvTaskFragment.adapter = mAdapter
    }
